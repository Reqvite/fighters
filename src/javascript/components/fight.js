    ...
    return new Promise(resolve => {
        ...
        const handleKeyUp = e => {
            if (e.code === controls.PlayerOneBlock) {
                ...
                controls.PlayerOneCriticalHitCombination.some(key => pressedKey.has(key)) ||
                controls.PlayerTwoCriticalHitCombination.some(key => pressedKey.has(key))
            ) {
                pressedKey.clear();
            }
        };
